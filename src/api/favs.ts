...
export async function setFavorite(
  ...
  const uri = `${import.meta.env.VITE_SERVER_URL}/images/setFavorite`;
...
export async function unsetFavorite(
  ...
  const uri = `${import.meta.env.VITE_SERVER_URL}/images/unsetFavorite`;
...
export async function getFavorites(
  ...
  const uri = `${import.meta.env.VITE_SERVER_URL}/images/getFavorite`;
